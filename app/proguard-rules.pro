...
-keepclassmembers class com.droidcon.schedule.** {
    *** Companion;
}
-keepclassmembers class com.jakewharton.retrofit2.** {
    *** Companion;
}
-keepclasseswithmembers class dev.androidcookers.droidcon.** { # <-- change package name to your app's
    kotlinx.serialization.KSerializer serializer(...);
}
-keepclasseswithmembers class com.jakewharton.retrofit2.** { # <-- change package name to your app's
    kotlinx.serialization.KSerializer serializer(...);
}
